                ...
                <tbody>
                    {itemsInCart.map((item, index) => (
                        <tr key={index} className="border-b border-accent-300">
                            ...
                            <td className="pl-10">
                                {new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR', maximumFractionDigits: 0 }).format(parseFloat(item.price) * item.quantity)}
                            </td>
                        </tr>
                    ))}
                    <tr className="sticky bottom-0 bg-accent-100">
                        ...
                        <td className="pl-10">
                            {new Intl.NumberFormat('en-IN', { style: 'currency', currency: 'INR', maximumFractionDigits: 0 }).format(parseFloat(totalPrice))}
                        </td>
                    </tr>
                </tbody>
            </table>
