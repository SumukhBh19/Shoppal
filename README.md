...
- [x] **Product Browsing**: Users can browse 150+ dummy products by category, price (in INR ₹), and rating. They can also search for specific items and view product details.
...
- [x] **Checkout Process**: Users can simulate a purchase by entering fake payment information and completing the checkout process. Total costs are automatically formatted in locally parsed INR (₹).
...
- [**DummyJSON**](https://dummyjson.com) - For providing the comprehensive mock product data used to populate the store's backend.
